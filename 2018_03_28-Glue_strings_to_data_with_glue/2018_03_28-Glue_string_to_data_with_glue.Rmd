...
<img src="benchmark-1.png" alt = "benchmark length 1 string" width = "75%">
...
glue("foo{bar}")
```
<img src="benchmark-100k.png" alt = "benchmark length 100k string" width = "75%">
...
night_or_day <- if (Sys.time() > sunset) "night" else "day"
