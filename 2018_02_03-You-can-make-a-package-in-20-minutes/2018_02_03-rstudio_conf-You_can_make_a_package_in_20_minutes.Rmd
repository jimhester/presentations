...
<div class = "fragment" style = "transform: rotate(25deg);left: 0;position: absolute;"><a href="https://github.com/susjoh/fibonacci"><br>Susan Johnston<br>@SuseJohnston</a></div>

## 📚 for 📦 development
<ul style = "display: block">
  <li class = "fragment">[R packages <r-pkgs.had.co.nz>](http://r-pkgs.had.co.nz/) <img data-src="http://r-pkgs.had.co.nz/cover.png" height="200em" style="float: right"></li>
  <li class = "fragment">[Writing R Extensions](https://cran.r-project.org/doc/manuals/r-release/R-exts.html)</li>
  <li class = "fragment">[rOpenSci Onboarding](https://github.com/ropensci/onboarding)</li>
</ul>

<h3 class = "fragment">Posts</h3>
> - <a href = "https://hilaryparker.com/2014/04/29/writing-an-r-package-from-scratch">Writing an R package from scratch - Hilary Parker (@hspter)</a>
> - <a href = "http://www.masalmon.eu/2017/12/11/goodrpackages/">How to develop good R packages - Maëlle Salmon (@ma_salmon)</a>
> - <a href = "http://tinyheero.github.io/jekyll/update/2015/07/26/making-your-first-R-package.html">Making your first R package - Fong Chun Chan (@fongchunchan)</a>
