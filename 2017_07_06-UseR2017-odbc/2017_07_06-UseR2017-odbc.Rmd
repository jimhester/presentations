...
- DBI compatible
- Complete Rewrite vs RODBC
- C++11 / Rcpp
- Native support for dates / timestamps / raw binary / 64 bit integers
- Parameterized queries / Batched insert, retrevial
...
## RStudio's DB Vision
- Consistent Interfaces - [DBI](https://cran.r-project.org/package=DBI), [dbplyr](https://cran.r-project.org/package=dbplyr)
- Commercial DBs, Free and Professional Drivers - [odbc](https://cran.r-project.org/package=odbc)
- Shiny Applications - [pool](https://github.com/rstudio/pool)
